...
function createDiscoveryServer() {
  ...
  server.tool(
    ...
    'Guarda temporalmente la información de descubrimiento capturada durante la conversación. Llamar cada vez que se obtiene un nuevo dato.',
    {
      conversation_id: z
        .string()
        .describe(
          'ID de la conversación ElevenLabs (valor conversation_id de la sección DATOS de tu prompt)'
        ),
      establishment_id: z
        .string()
        .describe(
      ...
      contact_email: z
        .string()
        .optional()
        .describe('Email del decision maker (para envios posteriores)'),
      ...
      interest_level: z
        ...
        .optional()
        .describe(
          'Nivel de interés evaluado: HIGH (muy interesado), MEDIUM (moderado), LOW (poco interesado)'
        ),
      ...
      sales_channel: z
        ...
        .optional()
        .describe('Canal de ventas (mostrador, whatsapp, apps, llamadas)'),
      ...
      closing_clarity: z
        ...
        .optional()
        .describe(
          'Claridad en el cierre del día: HIGH (claro y rápido), MEDIUM (toma tiempo), LOW (confuso)'
        ),
      previous_systems: z.string().optional().describe('Sistemas previos utilizados'),
      improvement_interest: z
        .string()
        .optional()
        .describe(
          'Interés en mejorar procesos: HIGH (muy interesado), MEDIUM (moderado), LOW (poco interesado)'
        ),
      problem_priority: z
        .string()
        .optional()
  ...
  server.tool(
    'save_discovery_outcome',
    'Guarda y registra el resultado final de la conversación de Discovery en campaign_enrichments. NO cuelga la llamada: después de esta SIEMPRE debes ejecutar el System Tool end_call para colgar.',
    {
      conversation_id: z
        .string()
        .describe(
      ...
      outcome: z
        ...
        .describe(
          'RESULTADO DE LA LLAMADA: INTERESTED (mostró interés), FOLLOW_UP_LATER (llamar después), NOT_INTERESTED (no interesado), WRONG_NUMBER (número incorrecto), NO_ANSWER (sin respuesta), VOICEMAIL (buzón de voz)'
        ),
      contact_name: z.string().optional().describe('Nombre del contacto o decision maker'),
      business_type: z
        .string()
        .optional()
        .describe('Tipo de negocio (ej: restaurante, panadería, cafetería)'),
      pain_point: z
        .string()
        .optional()
        .describe('Problema principal identificado en la conversación'),
      interest_level: z
        .string()
        .optional()
        .describe(
          'NIVEL DE INTERÉS del prospecto: HIGH (muy interesado), MEDIUM (moderadamente interesado), LOW (poco interesado). NOTA: Esto es DIFERENTE del outcome.'
        ),
      call_summary: z
        .string()
        .describe('Resumen breve de la conversación (2-3 oraciones sobre lo que pasó)'),
    },
    async ({
      conversation_id,
      establishment_id,
  ...
  server.tool(
    ...
    "Marca que se detectó un buzón de voz y registra el evento. Úsala cuando identifiques patrones de buzón: 'grave su mensaje', 'marque la tecla', menús automatizados, tonos DTMF, o falta de respuesta humana coherente en 2 turnos. Después de llamar a esta tool, ejecuta save_discovery_outcome con outcome='VOICEMAIL' y luego end_call para colgar. El único tool que cuelga la llamada es end_call.",
    {
          ...
          content: [
            {
              ...
              text: JSON.stringify({
                success: true,
                message:
                  "VOICEMAIL DETECTED. Execute save_discovery_outcome with outcome='VOICEMAIL', then end_call to hang up. DO NOT SPEAK. DO NOT WAIT.",
                ...result,
              }),
            },
          ],
