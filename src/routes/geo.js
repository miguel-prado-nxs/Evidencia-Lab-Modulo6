...
router.get(
  '/enrichment/meetings',
  authenticateJWTOrServiceKey,
  enrichmentController.getScheduledMeetings
);
...
router.get(
  ...
  authenticateJWT,
  requireAdmin,
  adminEnrichmentController.getAllEnrichments
);
 ...
 */
router.get(
  '/enrichment/admin/stats',
  authenticateJWT,
  requireAdmin,
  adminEnrichmentController.getGlobalStats
);
 ...
 */
router.get(
  '/enrichment/admin/by-level/:level',
  authenticateJWT,
  requireAdmin,
  adminEnrichmentController.getByLevel
);
 ...
 */
router.delete(
  '/enrichment/admin/:establishmentId',
  authenticateJWT,
  requireAdmin,
  adminEnrichmentController.deleteEnrichment
);
...
router.get(
  ...
  authenticateJWTOrServiceKey,
  requireVentasAdmin,
  adminSalesController.getSalesUsers
);
...
router.get(
  ...
  authenticateJWTOrServiceKey,
  requireVentasAdmin,
  adminSalesController.getAllProspects
);
...
router.get(
  ...
  authenticateJWTOrServiceKey,
  requireVentasAdmin,
  adminSalesController.getAllLeads
);
...
router.get(
  ...
  authenticateJWTOrServiceKey,
  requireVentasAdmin,
  adminSalesController.getAllClients
);
...
router.get(
  ...
  authenticateJWTOrServiceKey,
  requireVentasAdmin,
  adminSalesController.getSalesStats
);
...
router.post(
  '/ventas/contacts',
  authenticateJWTOrServiceKey,
  ventasEnrichmentController.addToContacts
);
 ...
 */
router.post(
  '/ventas/contacts/bulk',
  authenticateJWTOrServiceKey,
  ventasEnrichmentController.bulkAddToContacts
);
...
router.get(
  '/ventas/contacts',
  authenticateJWTOrServiceKey,
  ventasEnrichmentController.getMyContacts
);
 ...
 */
router.post(
  '/ventas/contacts/:establishmentId/to-prospect',
  authenticateJWTOrServiceKey,
  ventasEnrichmentController.convertContactToProspect
);
 ...
 */
router.patch(
  '/ventas/prospects/:establishmentId',
  authenticateJWTOrServiceKey,
  ventasEnrichmentController.updateProspect
);
 ...
 */
router.delete(
  '/ventas/enrichments/:establishmentId',
  authenticateJWTOrServiceKey,
  ventasEnrichmentController.removeFromMyList
);
 ...
 */
router.post(
  '/meetings/:establishmentId/calendly',
  authenticateJWTOrServiceKey,
  meetingController.createMeetingWithCalendly
);
 ...
 */
router.get(
  '/enrichment/:establishmentId',
  authenticateJWTOrServiceKey,
  enrichmentController.getEnrichment
);
...
router.post(
  '/enrichment/:establishmentId',
  authenticateJWTOrServiceKey,
  enrichmentController.updateEnrichment
);
 ...
 */
router.patch(
  '/enrichment/:establishmentId/meeting',
  authenticateJWTOrServiceKey,
  enrichmentController.updateMeetingDetails
);
...
router.delete(
  '/enrichment/:establishmentId',
  authenticateJWTOrServiceKey,
  enrichmentController.deleteEnrichment
);
