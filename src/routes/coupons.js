...
router.post(
  ...
  couponsController.trackVisit
);
router.post(
  '/:code/convert',
  authenticateApiKey,
  validate(markConvertedSchema),
  couponsController.markAsConverted
);
router.post(
  '/:code/redeem',
  authenticateApiKey,
...
router.post(
  '/generate-for-call',
  authenticateApiKey,
  validate(generateForCallSchema),
...
router.post(
  ...
  couponsController.checkEligibility
);
...
router.post(
  '/:couponId/assign',
  validate(assignToContactSchema),
  couponsController.assignToContact
);
