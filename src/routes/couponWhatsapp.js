...
router.post("/campaign-contact/:campaignContactId/send-coupons", validate(sendCouponsToCampaignContactSchema), couponWhatsappController.sendCouponsToCampaignContact);

// Generate and send coupon in one operation
router.post("/generate-and-send", validate(generateAndSendCouponSchema), couponWhatsappController.generateAndSendCoupon);

// Resend existing coupon
router.post("/:couponId/resend", validate(resendCouponSchema), couponWhatsappController.resendCoupon);
