...
async function authenticateSSE(req, res, next) {
  try {
    ...
    const salesUserName = req.query.salesUserName || req.headers["x-sales-user-name"] || "Equipo Ventas";
    const salesUserEmail = req.query.salesUserEmail || req.headers["x-sales-user-email"] || "ventas@easyorder.mx";
