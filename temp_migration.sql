...
-- CreateEnum
CREATE TYPE "EstablishmentLevel" AS ENUM ('ESTABLISHMENT', 'CONTACT', 'PROSPECT', 'LEAD', 'CLIENT');
...
-- CreateIndex
CREATE INDEX "establishment_enrichments_enrichment_status_idx" ON "establishment_enrichments"("enrichment_status");

-- CreateIndex
CREATE INDEX "establishment_enrichments_strategy_idx" ON "establishment_enrichments"("strategy");

-- CreateIndex
CREATE INDEX "establishment_enrichments_call_status_idx" ON "establishment_enrichments"("call_status");
